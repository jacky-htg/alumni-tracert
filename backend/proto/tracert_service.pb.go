...
var file_tracert_service_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x95, 0x0c, 0x0a, 0x0e,
	...
	0x6f, 0x2e, 0x4c, 0x65, 0x67, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x10,
	0x4c, 0x65, 0x67, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x65, 0x64,
	0x12, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4c,
	0x65, 0x67, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x10, 0x4c, 0x65, 0x67,
	0x61, 0x6c, 0x69, 0x7a, 0x65, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x64, 0x12, 0x14, 0x2e,
...
var file_tracert_service_proto_depIdxs = []int32{
	...
	8,  // 20: proto.TracertService.LegalizeRejected:input_type -> proto.StringMessage
...
type TracertServiceClient interface {
	...
	LegalizeRejected(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*Legalize, error)
...
func (c *tracertServiceClient) LegalizeRejected(ctx context.Context, in *StringMessage, opts ...grpc.CallOption) (*Legalize, error) {
	out := new(Legalize)
...
type TracertServiceServer interface {
	...
	LegalizeRejected(context.Context, *StringMessage) (*Legalize, error)
...
func (*UnimplementedTracertServiceServer) LegalizeRejected(context.Context, *StringMessage) (*Legalize, error) {
...
func _TracertService_LegalizeRejected_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TracertServiceServer).LegalizeRejected(ctx, req.(*StringMessage))
	}
	return interceptor(ctx, in, info, handler)
}
