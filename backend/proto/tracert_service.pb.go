...
var file_tracert_service_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xdf, 0x04, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x63,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x28, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72,
...
var file_tracert_service_proto_depIdxs = []int32{
	...
	5,  // 7: proto.TracertService.UserCreate:input_type -> proto.User
	3,  // 8: proto.TracertService.UserList:input_type -> proto.ListInput
	6,  // 9: proto.TracertService.UserAnswerCreate:input_type -> proto.UserAnswer
	5,  // 10: proto.TracertService.Login:output_type -> proto.User
	7,  // 11: proto.TracertService.QuestionList:output_type -> proto.QuestionGroupList
	2,  // 12: proto.TracertService.AlumniCreate:output_type -> proto.Alumni
	8,  // 13: proto.TracertService.AlumniList:output_type -> proto.AlumniListResponse
	2,  // 14: proto.TracertService.AlumniGet:output_type -> proto.Alumni
	4,  // 15: proto.TracertService.AlumniAppraiserCreate:output_type -> proto.AlumniAppraiser
	9,  // 16: proto.TracertService.AlumniAppraiserList:output_type -> proto.AlumniAppraiserListResponse
	5,  // 17: proto.TracertService.UserCreate:output_type -> proto.User
	10, // 18: proto.TracertService.UserList:output_type -> proto.UserListResponse
	6,  // 19: proto.TracertService.UserAnswerCreate:output_type -> proto.UserAnswer
