...
goog.exportSymbol('proto.proto.AlumniAppraiserList', null, global);
/**
 ...
 * @constructor
 */
proto.proto.AlumniAppraiserList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.proto.AlumniAppraiserList.repeatedFields_, null);
};
goog.inherits(proto.proto.AlumniAppraiserList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.proto.AlumniAppraiserList.displayName = 'proto.proto.AlumniAppraiserList';
}
 ...
 * @const
 */
proto.proto.AlumniAppraiserList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.proto.AlumniAppraiserList.prototype.toObject = function(opt_includeInstance) {
  return proto.proto.AlumniAppraiserList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.proto.AlumniAppraiserList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.AlumniAppraiserList.toObject = function(includeInstance, msg) {
  var f, obj = {
    alumniAppraiserList: jspb.Message.toObjectList(msg.getAlumniAppraiserList(),
    proto.proto.AlumniAppraiser.toObject, includeInstance),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.proto.AlumniAppraiserList}
 */
proto.proto.AlumniAppraiserList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.proto.AlumniAppraiserList;
  return proto.proto.AlumniAppraiserList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.proto.AlumniAppraiserList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.proto.AlumniAppraiserList}
 */
proto.proto.AlumniAppraiserList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.proto.AlumniAppraiserList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.proto.AlumniAppraiserList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.proto.AlumniAppraiserList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.proto.AlumniAppraiserList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAlumniAppraiserList();
  if (f.length > 0) {
...
/**
 * repeated AlumniAppraiser alumni_appraiser = 1;
 * @return {!Array<!proto.proto.AlumniAppraiser>}
 */
proto.proto.AlumniAppraiserList.prototype.getAlumniAppraiserList = function() {
  return /** @type{!Array<!proto.proto.AlumniAppraiser>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.proto.AlumniAppraiser, 1));
};


/**
 * @param {!Array<!proto.proto.AlumniAppraiser>} value
 * @return {!proto.proto.AlumniAppraiserList} returns this
*/
proto.proto.AlumniAppraiserList.prototype.setAlumniAppraiserList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.proto.AlumniAppraiser=} opt_value
 * @param {number=} opt_index
 * @return {!proto.proto.AlumniAppraiser}
 */
proto.proto.AlumniAppraiserList.prototype.addAlumniAppraiser = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.proto.AlumniAppraiser, opt_index);
};
 ...
 * @return {!proto.proto.AlumniAppraiserList} returns this
 */
proto.proto.AlumniAppraiserList.prototype.clearAlumniAppraiserList = function() {
  return this.setAlumniAppraiserList([]);
};
 ...
 */
proto.proto.AlumniAppraiserList.prototype.getListInput = function() {
 ...
 * @return {!proto.proto.AlumniAppraiserList} returns this
*/
proto.proto.AlumniAppraiserList.prototype.setListInput = function(value) {
 ...
 * @return {!proto.proto.AlumniAppraiserList} returns this
 */
proto.proto.AlumniAppraiserList.prototype.clearListInput = function() {
 ...
 * @return {boolean}
 */
proto.proto.AlumniAppraiserList.prototype.hasListInput = function() {
